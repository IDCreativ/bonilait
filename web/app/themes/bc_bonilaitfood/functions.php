...
function bc_bonilaitfood_scripts() {
	...
	wp_enqueue_script('bc_bonilaitfood-bootstrap-js', 'https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js', array(), '20151215', true);
	wp_enqueue_script('bc_bonilaitfood-animate-js', get_template_directory_uri() . '/assets/js/animate.js', array(), '20151215', true);
	wp_enqueue_script('bc_bonilaitfood-main-js', get_template_directory_uri() . '/assets/js/main.js', array(), '20151215', true);
